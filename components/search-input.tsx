...
export default function SearchInput() {
  return (
    <div className="relative w-full h-12 md:h-16">
      <input
        className="w-full h-full md:px-4 text-sm md:text-lg text-gray-800 bg-white-smoke border-none rounded-xl focus:outline-none foc us:ring-2 focus:ring-purple
